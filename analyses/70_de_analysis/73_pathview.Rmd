...
```{r, include=FALSE}
pathview_p = function(pathway, file_suffix="") {
  pathview(
    gene_p,
    pathway.id = pathway,
    ...
    out.suffix = paste0("logfdr.pathview", file_suffix)
  )
  knitr::include_graphics(paste0(pathway, ".logfdr.pathview", file_suffix, ".png"))
}
