...
names(gene_p) = de_res$ENTREZID
names(gene_fc) = de_res_filtered$ENTREZID
```

```{r, include=FALSE}
pathview_p = function(pathway) {
  pathview(
    gene_p,
    pathway.id = pathway,
    ...
    out.suffix = "logfdr.pathview"
  )
  knitr::include_graphics(paste0(pathway, ".logfdr.pathview.png"))
}

pathview_fc = function(pathway) {
  pathview(
    gene_fc,
    pathway.id = pathway,
    ...
    high = c(gene = "#ca0020", cpd = "yellow"),
    bins = c(gene=20, cpd=20),
    out.suffix = "sigfc.pathview"
  )
  knitr::include_graphics(paste0(pathway, ".sigfc.pathview.png"))
}
```
...
# pathview_p("hsa04010")
pathview_fc("hsa04010")
# pathview_p("hsa04310")
pathview_fc("hsa04310")
